...
```bash
git clone https://github.com/jsercao/es6-gitbook.git
cd es6-gitbook
gitbook build
```
 ...
 具体如何使用`Gitbook`,参阅[Github地址](https://github.com/GitbookIO/gitbook/blob/master/docs/setup.md)
